// Dafny program simple-methods.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\颜-个人\澳洲，新西兰，爱尔兰\Australia\国立\CoursePPT\Foudation of Computing\code\lecture14-dafny-code\lecture14\simple-methods.dfy
// simple-methods.dfy

method maxMinMethod(i: int, j: int)
    returns (mx: int, mn: int)
  decreases i, j
{
  if i < j {
    mx := j;
...
namespace _module {
  ...
  public partial class __default {
    public static void maxMinMethod(BigInteger i, BigInteger j, out BigInteger mx, out BigInteger mn)
    {
      mx = BigInteger.Zero;
      mn = BigInteger.Zero;
      if ((i) < (j)) {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _out0;
      BigInteger _out1;
      __default.maxMinMethod(new BigInteger(10), new BigInteger(3), out _out0, out _out1);
      _0_x = _out0;
      _1_n = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Min is ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_n));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("; max is ")).ToVerbatimString(false));
